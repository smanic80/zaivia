        ...
        <div class="row gutters-44">
            <div class="col-xl-9">
                <div class="sub-filter">
                    ...
                    <ul>
                        <li class="current"><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i>List View</a>
                        </li>
                ...
                <aside class="side-widgets">
                    ...
                    <?php if (get_field('sidebar_banner_url')): ?>
                        <div class="widget widget-ad">
                            <a href="<?php echo get_field('sidebar_banner_url'); ?>">
                                <img src="<?php echo get_field('sidebar_banner_image'); ?>" alt="">
                            </a>
                        </div>
                    <?php endif; ?>
                </aside>
